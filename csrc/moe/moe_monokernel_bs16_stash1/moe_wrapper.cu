...
static_assert(
    offsetof(moe_monokernel::MoEGemmSpec<
        ...
        moe_monokernel::MoEGemmSpec<
            ...
            TEMP_FP8_OFFSET,
    "TEMP_FP8_OFFSET must match offsetof(MoEGemmSpec<Dims>, temp_fp8) for "
    "Dims_BS16_E256_Qwen3_5_35B_BlockFP8_WGMMA_TMA. Do not insert "
    "fields before temp_fp8; grid_barrier / partial_barrier belong at the "
    "tail of MoEGemmSpec<Dims>.");
...
// BS16 instantiation of the same WGMMA_TMA Pair_Layout V2 path.
// Reuses the moe_kernel_topk_BS8 template body verbatim (Req 1.3); selected
// by host dispatch when 8 < token_count <= 16.
MOEMONOKERNEL_TOPK_WRAPPER_IMPLEMENTATION(
    moe_monokernel_topk_BS16_E256_Qwen3_5_35B_BlockFP8_WGMMA_TMA_impl,
    moe_monokernel::Dims_BS16_E256_Qwen3_5_35B_BlockFP8_WGMMA_TMA)
