#!/bin/bash
# =============================================================================
# vllm bench serve benchmark for Qwen/Qwen3.5-35B-A3B-FP8
#
...
# Configuration
# -----------------------------
VENV_ACTIVATE="$HOME/vllm_main_pr/.venv_vllm/bin/activate"
...
DATASET_NAME="sonnet"
DATASET_PATH="$HOME/vllm_main_pr/sonnet.txt"
INPUT_LEN=1600
OUTPUT_LEN=200
...
RUN_DIR="$HOME/vllm_main_pr/result_outputs/vllm_bench/${MODEL_NAME}/sonnet_${INPUT_LEN}_out_${OUTPUT_LEN}/tp_${TENSOR_PARALLEL_SIZE}/run_${GPU_NAME}_${RUN_STAMP}"
...
run_benchmark() {
    for bs in "${BATCH_SIZES[@]}"; do
        ...
        local result_filename="qwen35_sonnet_bs${bs}.json"
