...
class VllmEngineStub:
    ...
    def __init__(self, channel):
        ...
        self.Generate = channel.unary_stream(
            ...
            request_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GenerateRequest.SerializeToString,
            response_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GenerateResponse.FromString,
            _registered_method=True)
        self.Embed = channel.unary_unary(
            '/vllm.grpc.engine.VllmEngine/Embed',
            request_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            EmbedRequest.SerializeToString,
            response_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
        ...
        self.Abort = channel.unary_unary(
            ...
            response_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            AbortResponse.FromString,
            _registered_method=True)
        self.GetModelInfo = channel.unary_unary(
            '/vllm.grpc.engine.VllmEngine/GetModelInfo',
            request_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetModelInfoRequest.SerializeToString,
            response_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetModelInfoResponse.FromString,
            _registered_method=True)
        self.GetServerInfo = channel.unary_unary(
            '/vllm.grpc.engine.VllmEngine/GetServerInfo',
            request_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetServerInfoRequest.SerializeToString,
            response_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetServerInfoResponse.FromString,
            _registered_method=True)
...
def add_VllmEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_stream_rpc_method_handler(
            servicer.Generate,
            request_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GenerateRequest.FromString,
            response_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GenerateResponse.SerializeToString,
        ),
        'Embed':
        grpc.unary_unary_rpc_method_handler(
            servicer.Embed,
            request_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            EmbedRequest.FromString,
            response_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            EmbedResponse.SerializeToString,
        ),
        'HealthCheck':
        grpc.unary_unary_rpc_method_handler(
        ...
        grpc.unary_unary_rpc_method_handler(
            servicer.Abort,
            request_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            AbortRequest.FromString,
            response_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            AbortResponse.SerializeToString,
        ),
        'GetModelInfo':
        grpc.unary_unary_rpc_method_handler(
            servicer.GetModelInfo,
            request_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetModelInfoRequest.FromString,
            response_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetModelInfoResponse.SerializeToString,
        ),
        'GetServerInfo':
        grpc.unary_unary_rpc_method_handler(
            servicer.GetServerInfo,
            request_deserializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetServerInfoRequest.FromString,
            response_serializer=vllm_dot_grpc_dot_vllm__engine__pb2.
            GetServerInfoResponse.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        'vllm.grpc.engine.VllmEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler, ))
    server.add_registered_method_handlers('vllm.grpc.engine.VllmEngine',
                                          rpc_method_handlers)
...
class VllmEngine:
    ...
    def Generate(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/vllm.grpc.engine.VllmEngine/Generate',
            vllm_dot_grpc_dot_vllm__engine__pb2.GenerateRequest.
            SerializeToString,
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vllm.grpc.engine.VllmEngine/HealthCheck',
            vllm_dot_grpc_dot_vllm__engine__pb2.HealthCheckRequest.
            SerializeToString,
    ...
    def GetModelInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vllm.grpc.engine.VllmEngine/GetModelInfo',
            vllm_dot_grpc_dot_vllm__engine__pb2.GetModelInfoRequest.
            SerializeToString,
            vllm_dot_grpc_dot_vllm__engine__pb2.GetModelInfoResponse.
            FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetServerInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vllm.grpc.engine.VllmEngine/GetServerInfo',
            vllm_dot_grpc_dot_vllm__engine__pb2.GetServerInfoRequest.
            SerializeToString,
            vllm_dot_grpc_dot_vllm__engine__pb2.GetServerInfoResponse.
            FromString,
            options,
            channel_credentials,
            insecure,
